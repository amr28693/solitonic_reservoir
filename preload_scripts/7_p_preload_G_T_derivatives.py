...
Files saved as: 'preload_derivative_analysis.png' and 'preload_derivative_analysis.pdf' in the 'preload_figures/' folder.
...
g_data = np.load('preload_data/preload_etaV2g_sweep_results.npz')
time_data = np.load('preload_data/preload_time_sweep_results.npz')
...
plt.tight_layout()
plt.savefig('preload_figures/preload_derivative_analysis.png', dpi=300, bbox_inches='tight')
plt.savefig('preload_figures/preload_derivative_analysis.pdf', bbox_inches='tight')
print("\n" + "=" * 60)
print("Plots saved: preload_derivative_analysis.png and .pdf")
print("=" * 60)