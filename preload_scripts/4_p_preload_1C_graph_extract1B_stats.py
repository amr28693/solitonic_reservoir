...
try:
    data = np.load('preload_data/etaV2paper1C_robustness_sweep_STATISTICAL.npz')
...
# Save the figure
plt.savefig('preload_figures/etaV2paper1C_robustness_sweep_FINAL_PLOT.png', dpi=300, bbox_inches='tight')
plt.savefig('preload_figures/etaV2paper1C_robustness_sweep_FINAL_PLOT.pdf', bbox_inches='tight')
