...
plt.savefig('preload_figures/preload_etaV2_paper_nlse_superiority_margin_annotated.png', dpi=300, bbox_inches='tight')
plt.savefig('preload_figures/preload_etaV2_paper_nlse_superiority_margin_annotated.pdf', bbox_inches='tight')
plt.show()
