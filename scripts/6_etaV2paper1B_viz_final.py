...
data = np.load('data/etaV2g_sweep_results.npz')
...
plt.savefig('figures/etaV2paper1B_g_sweep_margin.png', dpi=300, bbox_inches='tight')
# PDF for high-quality printing and manuscript submission
plt.savefig('figures/etaV2paper1B_g_sweep_margin.pdf', bbox_inches='tight')
