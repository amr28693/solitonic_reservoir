...
*note: The repository name reflects an earlier project title (see paper, Section 7.2)*
...
│   ├── 0_soliton_fig1_generator.ipynb            # Illustrative; not depicted in the quantitative results
